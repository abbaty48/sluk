...
import { ArticleDetailsLanguage, ArticleDetailsShareButton, ArticleDetailsSpeechButton } from "./ArticleDetailsComponents";
...
export function ArticleDetails({ article, files, pdfFile, docFile, videoFile, imageFile }: { article: TEnrichedArticle, files: any; pdfFile: any; docFile: any; videoFile: any; imageFile: any; }) {
    ...
    const { updateHistory } = useArticlesHistory();
    const { lang, changeLanguage } = useTranslateSummary(stopSpeaking);
    ...
    } = useArticleTranslation(article.title || "", article.abstract || "", i18n.language, "en");

    useEffect(() => {
        updateHistory({ ...article, imageUrl: imageFile?.file_path || article.thumbnail });
    }, [])
                ...
                <div className="container-full mx-auto px-4 py-4">
                    <div className="flex items-center justify-between flex-wrap gap-4">
                        ...
                        <div className="flex items-center gap-2 flex-wrap">
                            {/* Language Switcher */}
                            <ArticleDetailsLanguage
                                currentLanguage={i18n.language}
                                changeLanguage={changeLanguage}
                            />

                            {/* Read Aloud Button */}
                            <ArticleDetailsSpeechButton
                                t={t}
                                lang={lang}
                                speak={speak}
                                ...
                                <div className="relative aspect-video rounded-lg overflow-hidden bg-black shadow-lg">
                                    ...
                                    >
                                        <ReactPlayer
                                            ...
                                            height="100%"
                                            playing={false}
                                            src={videoFile ? videoFile.file_path : ""}
