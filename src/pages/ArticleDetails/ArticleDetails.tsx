...
const ArticleReviews = lazy(() =>
  import("./ArticleReviews").then((m) => ({ default: m.ArticleReviews })),
);
...
export function ArticleDetails({
  ...
  useEffect(() => {
    updateHistory({
      ...article,
      imageUrl: imageFile?.file_path || article.thumbnail,
    });
  }, [imageFile, updateHistory, article]);
