...
const languages = ['All', 'English', 'Arabic', 'French', 'Chinese', 'Hausa'];

export function SearchFilter() {
    const { isFilterOpen, setIsFilterOpen } = useFilterState()
    const { filters, onFilterChange, handleAuthorChange, handleCategoryChange, handleLanguageChange, handleFileTypeChange, handleYearChange } = useFilter()
